...
var describe = global_1.default.describe, globalWindow = global_1.default.window;
...
function testStorySnapshots(options) {
    ...
    globalWindow.__STORYBOOK_STORY_STORE__.initializationPromise.then(function () {
        var data = storybook.raw().reduce(function (acc, item) {
